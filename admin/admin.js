...
const showNotification = showAdminToast;
...
// ========== FONCTIONS POUR LE SITE (NÉCESSAIRES POUR ADMIN) ==========
function showTarifs() {
    console.log('📦 Tarifs - fonction appelée depuis admin');
    // Fonction vide pour éviter les erreurs
}

function showAbonnements() {
    console.log('📦 Abonnements - fonction appelée depuis admin');
    // Fonction vide pour éviter les erreurs
}
...
function changePassword() {
    ...
    showAdminToast("📤 Changement en cours...", 'info');
...
function loadStats() {
    ...
    .then(data => {
        ...
        // Formatage du prix avec séparateur
